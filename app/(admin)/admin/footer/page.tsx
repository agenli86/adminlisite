    ...
    <AdminLayout>
      <div className="max-w-4xl">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Footer Ayarları</h1>
            <p className="text-gray-500">Site alt bilgi alanını düzenleyin</p>
          </div>
          <button
            onClick={handleSave}
            disabled={saving}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Footer İçeriği</h2>
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary-500"
                  placeholder="© 2024 Firma Adı. Tüm hakları saklıdır."
                />
              </div>
            </div>
          </div>
          ...
          {/* Sosyal Medya */}
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Sosyal Medya Linkleri</h2>
